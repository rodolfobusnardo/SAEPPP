...
function start_secure_session() {
    ...
    // Nós só podemos definir o nome ANTES da sessão ser iniciada.
    // Então, movemos o session_name() para DENTRO do 'if'.
    if (session_status() == PHP_SESSION_NONE) {
        session_name('SISTEMA_PERDIDOS_SESSID'); // <-- MOVIDO PARA CÁ
        session_start();
    }
