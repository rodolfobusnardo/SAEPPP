...
try {
    ...
    // ====================== LINHA CORRIGIDA ======================
    // Adicionado "updated_at = NOW()" para registrar a data/hora exata da doação.
    $stmt_term = $conn->prepare("UPDATE donation_terms SET status = 'Doado', signature_image_path = ?, updated_at = NOW() WHERE term_id = ? AND status = 'Aprovado'");
    // =============================================================
