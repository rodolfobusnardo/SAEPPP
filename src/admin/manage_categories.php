...
/* ================================================================== */
/* As classes d-none, d-lg-table e d-lg-none vêm do Bootstrap (incluído no header.php) */
/* Este CSS adicional é para refinar a aparência dos botões nos cards. */
@media (max-width: 991.98px) {
    ...
    .card-footer .actions-wrapper .button-edit,
    .card-footer .actions-wrapper .button-delete {
...
/* ================================================================== */
/* CORREÇÃO DOS BOTÕES DO FORMULÁRIO DE EDIÇÃO                */
/* ================================================================== */
#editCategorySection .form-action-buttons-group {
    justify-content: center; /* Centraliza os botões horizontalmente */
}

#editCategorySection .button-primary,
#editCategorySection .button-secondary {
    height: 38px; /* Define uma altura fixa para ambos, igual ao botão "Adicionar" */
    display: flex;
    align-items: center; /* Centraliza o texto verticalmente no botão */
    padding-top: 0;
    padding-bottom: 0;
}
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <span>ID: <?php echo htmlspecialchars($category['id']); ?></span>
                </div>
                <div class="card-body">
                    <p class="card-text"><strong>Código:</strong> <?php echo htmlspecialchars($category['code']); ?></p>
                </div>
