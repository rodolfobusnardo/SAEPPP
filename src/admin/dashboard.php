...
@media (max-width: 768px) {
    .filters-row {
        ...
        align-items: stretch;   /* Faz com que todos ocupem a largura total */
    }

    .filters-row .filter-input {
        width: 100%; /* Garante que os campos de data/select ocupem 100% da largura */
    }
    ...
    .charts-grid {
        /* Força os gráficos a ficarem em uma única coluna em telas pequenas */
