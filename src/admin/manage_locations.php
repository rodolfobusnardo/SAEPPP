...
#editLocationSection .form-action-buttons-group {
    justify-content: center; /* Centraliza os botões horizontalmente */
}

#editLocationSection .button-primary,
#editLocationSection .button-secondary {
    height: 38px; /* Define uma altura fixa para ambos */
    display: flex;
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <span>ID: <?php echo htmlspecialchars($location['id']); ?></span>
                </div>
