...
<style>
    ...
    .actions-cell .actions-wrapper { display: flex !important; flex-direction: row !important; gap: 8px !important; align-items: center !important; justify-content: center; }
    ...
    @media (max-width: 991.98px) {
        /* Garante que os formulários de registro e filtro fiquem verticais */
        .admin-section-box .form-row {
        ...
        .filter-buttons-group > .button-primary,
        .filter-buttons-group > a.button-secondary {
            width: 100%;
        ...
        .card-footer .actions-wrapper-cards .button-action,
        .card-footer .actions-wrapper-cards form {
            flex: 1; /* Faz os botões dividirem o espaço */
        }
        .card-footer .actions-wrapper-cards .button-action {
             width: 100%; /* Garante que o botão dentro do form ocupe todo o espaço */
        }
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-secondary"><?= htmlspecialchars($roles[$user['role']] ?? $user['role']); ?></span>
                </div>
                <div class="card-body">
                    <p class="card-text mb-2"><strong>Usuário:</strong> <?= htmlspecialchars($user['username']); ?></p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // É preciso delegar o evento para um container pai que sempre existe,
    // pois os cards são adicionados/removidos dinamicamente em implementações futuras
    document.body.addEventListener('click', function(event) {
        const editButton = event.target.closest('.button-action.edit');
        if (editButton) {
            const userData = editButton.dataset;
