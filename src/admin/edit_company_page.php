...
<form action="<?php echo $company_id ? 'edit_company_handler.php' : 'add_company_handler.php'; ?>" method="POST" class="form-modern" style="margin-top: 20px;">
    <?php if ($company_id): ?>
    ...
    <fieldset class="data-section-rounded">
        ...
        <div class="form-row">
            ...
            <div class="form-group_col_button">
                 <button type="button" id="searchCepButton" class="button-secondary">Buscar CEP</button>
            </div>
        </div>
        <div class="form-row">
...
<style>
    ...
    /* Ajustes para garantir que o layout do formulário seja consistente */
    ...
    .form-modern legend {
    width: 100%; /* Faz a legenda ocupar toda a largura do painel */
    ...
    @media (max-width: 768px) {
        /* Faz todos os grupos de formulário ocuparem 100% da largura */
        .form-modern .form-group_col,
        .form-modern .form-group_col-small,
        .form-modern .form-group_col-large {
            flex-basis: 100%; 
        ...
        /* Ajusta o botão de buscar CEP para ficar abaixo do input */
        .form-modern .form-row {
            gap: 0; /* Remove o gap para empilhar melhor */
        }
         .form-group_col_button {
            width: 100%;
            margin-top: 10px;
        ...
        /* Faz os botões de ação final ocuparem a largura total */
        .form-action-buttons-group {
            flex-direction: column;
            gap: 10px;
        }
        .form-action-buttons-group .button-primary,
        .form-action-buttons-group .button-secondary {
            width: 100%;
